...
static int client_accept_cmd(struct xml_state *sp, int argc, char **argv)
{
	...
	CLIENT_DEBUG(LOG_DEBUG,
	    "id=%d method=%s resource=%s, uri=%s",
...
extern int flag_work_mode,flag_ap_mode,flag_airkiss_mode,flag_connect_fail,flag_device_down;
/*
