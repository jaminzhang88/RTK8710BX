...
#define NET_UDP_MAX_SZ		800	/* max RX frame size */
#define NET_UDP_TASK_STACKSZ	((1 * 1024 + 512) / sizeof(portSTACK_TYPE))
#define NET_TIMER_TASK_STACKSZ	((2 * 1024 + 512) / sizeof(portSTACK_TYPE))
#else
